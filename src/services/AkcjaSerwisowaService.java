...
//        return ConnectionManager.getStatementResultSet("select ID_AKCJI, ID_SAMOCHODU, ID_KLIENTA, OPIS, ID_FAKTURY, ID_PRACOWNIKA, ID_SAMOCHODU_ZASTEPCZEGO, to_char(DATA_ROZPOCZECIA,'YYYY-MM-DD'), DATA_ZAKONCZENIA from AKCJA_SERWISOWA");
    }
