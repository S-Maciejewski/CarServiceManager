...
--select * from SAMOCHOD left join SAMOCHOD_ZASTEPCZY on ID_SAMOCHODU_ZASTEPCZEGO = ID_SAMOCHODU where ID_SAMOCHODU_ZASTEPCZEGO is NULL;
--update SAMOCHOD set NUMER_REJESTRACYJNY = 'GDY426E', VIN = '1FMDU73W83UA86147', MARKA = 'Opel', MODEL = 'Vectra', POJEMNOSC = '1875', ROK_PRODUKCJI = null where ID_SAMOCHODU = '605';